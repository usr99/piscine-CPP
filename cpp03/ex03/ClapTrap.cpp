...
/*   Updated: 2021/04/21 17:18:11 by mamartin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			ClapTrap::getHitPoints(void) const { return (this->_nHitPoints); }
int			ClapTrap::getEnergyPoints(void) const { return (this->_nEnergyPoints); }
std::string	ClapTrap::getName(void) const { return (this->_sName); }
